...
void createWebServer(int webtype)
{
  if ( webtype == 1 ) {
    ...
    Usage: x.x.x.x/wifiSetup?ssid=SSID&pass=PASSWORD */
    ...
    */
    ...
    /* This URL is used to produce live read from the sensors 
    Usage: x.x.x.x/sensors
    */
    ...
    /* This URL is used to set manual or automatic mode for the watering pump, 
    Usage: x.x.x.x/uploadSettings?pump=n where 0=off and 1=auto
    */
  ...
  /* 
  This URL is used to generate JSON output from files that are stored on SD card 
  Usage: x.x.x.x/log?data=log(n) where n is number starting from 01 and increments by 1 every 10 seconds
  */
